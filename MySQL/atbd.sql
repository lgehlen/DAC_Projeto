...
-- Table `always`.`Estado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Estado` (
...
-- Table `always`.`Cidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Cidade` (
  ...
  CONSTRAINT `fk_Cidade_Estado1`
    ...
    REFERENCES `always`.`Estado` (`idEstado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `always`.`Endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Endereco` (
  ...
  CONSTRAINT `fk_Endereco_Cidade`
    ...
    REFERENCES `always`.`Cidade` (`idCidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `always`.`Evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Evento` (
  ...
  CONSTRAINT `fk_Evento_Endereco1`
    ...
    REFERENCES `always`.`Endereco` (`idEndereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `always`.`Atributo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Atributo` (
...
-- -----------------------------------------------------
-- Table `always`.`Cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Cliente` (
  ...
  CONSTRAINT `fk_Cliente_Atributo1`
    ...
    REFERENCES `always`.`Atributo` (`IdAtributo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `always`.`Encontro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Encontro` (
  ...
  CONSTRAINT `fk_Encontro_Cliente1`
    ...
    REFERENCES `always`.`Cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `always`.`Produtividade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`Produtividade` (
  `data` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `always`.`ListaConvidados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `always`.`ListaConvidados` (
  `Cliente_idCliente` INT NOT NULL,
  ...
  CONSTRAINT `fk_ListaConvidados_Evento1`
    ...
    REFERENCES `always`.`Evento` (`idEvento` , `Convidado_idPar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
